...
opts_knit$set(root.dir = "C:/Users/User/Documents/UIUC/20170518_Membran/FrictionCellMembranes/FrictionCellMembranes")
...
# path to AFM files on the server or a local machine, all files in that folder will be read
        ...
        mypath <- "C:/Users/User/Documents/UIUC/20170518_Membran/FrictionCellMembranes/FrictionCellMembranes/02_Data"  
...
```
```{r, eval = TRUE, echo = FALSE, fig.show = "asis", fig.width=14, fig.height=8, result = "hide"}
# Histogram dyMax in dependency of the slope
dyMaxHistogram(mydata, low = -300000, up = 20000000, same_scale = FALSE,  bi =500, set_x_marker = 0, colS = colSet)
```
